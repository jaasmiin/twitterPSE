...
\begin{itemize}
	\item Methoden welche über alle Daten (im Sinne von Kalenderdaten) summieren
	\begin{itemize}
	...
	\end{itemize}
	\item Methoden welche die Daten nach Daten (im Sinne von Kalenderdaten) separieren
	\begin{itemize}
	...
	\end{itemize}
\end{itemize}
Die Berechnungen werden so weit möglich in die Datenbank ausgelagert, sodass diese die Summation übernimmt.
