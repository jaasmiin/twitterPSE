 ...
 */
public class Labels {
	public final static String PSE_TWITTER = "PSE-Twitter";
	...
	public static final String CATEGORIES_LOADED = Util.getUppercaseStart(CATEGORIES) + " loaded.";
	public static final String LOCATIONS_LOADING = "Loading " + LOCATIONS + "...";
	public static final String LOCATIONS_LOADED = Util.getUppercaseStart(LOCATIONS) + " loaded.";
	public static final String ACCOUNTS_LOADING = "Loading " + ACCOUNTS + "...";
	public static final String ACCOUNTS_LOADED = Util.getUppercaseStart(ACCOUNTS) + " loaded.";
