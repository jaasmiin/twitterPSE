...
public class MyDataEntry {
     ...
     * 
     * @param value
     *            (relative) of the country
     * @param countryName
     *            the name of this country
     * @param retweetsLand
     *            the total number of retweets from this country
     * @param retweetsLandFiltered
     *            the number of retweets from this country that match the chosen
     *            filter combination
     */
    public MyDataEntry(double value, String countryName, int retweetsLand,
            int retweetsLandFiltered) {
        this.value = value;
     ...
     * 
     * @param retweetsLandFiltered
     *            the number of retweets in this land with the chosen filter
     */
